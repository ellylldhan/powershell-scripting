...
$ip1 = '01010000101000100110010100111100'
$mask = 17
...
$bin2dec=(convertBinToDec $ip1)

$niceBin=niceDisplayIpBin $dec2bin $mask


Write-Host "DEC to BIN $ip2 / $mk2 => $dec2bin" 
Write-Host "BIN to DEC $ip1 => $bin2dec" 

write-host "Nice Display $ip2 => $niceBin"

# $resultat = niceDisplayIpBin('01010000101000100110010100111100', 0)

# Write-Host $ip1 $mask
write-host "Nice Display" $ip1 "=>" $resultat